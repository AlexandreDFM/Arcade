...
//        std::cerr << "SDL_image Error: " << IMG_GetError() << std::endl; return;
//    }
    // Init SDL_ttf
//    if (TTF_Init() == -1) {
//        std::cerr << "SDL_ttf Error: " << TTF_GetError() << std::endl; return;
//    }
    // Create window
...
//    if (_font == nullptr) {
//        std::cerr << "TTF_OpenFont Error: " << TTF_GetError() << std::endl; return;
//    }
}
...
//    if (surface == nullptr) {
//        std::cerr << "TTF_RenderText_Solid Error: " << TTF_GetError() << std::endl; return;
//    }
    // Create texture
